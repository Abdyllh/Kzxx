const developer_Name = "Ardit , AbDoo#2365"; // My Account Name
const developer_Id = "713700568954044428"; // My Account ID.
const YouTube_Channel = "Abdulrahman Tube" // YouTube Channel.
...
const admin = "704971152052715521"; // ايدي الي يتحكم بالبوت
...
client.on('ready', () => {
  ...
  client.user.setActivity(`Abdulrahman Tube`, {
    type: "PLAYING"
  });
...
app.listen(() => console.log(`v2 Broadcast Bot By Abdulrahman Tube
